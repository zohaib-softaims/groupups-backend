...
import { verifyEmail, resendVerificationEmail, loginUser, forgotPassword, resetPassword, logoutUser, updateEmail, updatePassword } from "./controllers.js";
...
router.patch("/update-password", authMiddleware, validate(updatePasswordValidator), updatePassword);
